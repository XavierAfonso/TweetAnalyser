...
case class TweetResponse(id: Long, author_screen_name: String, tweet_id: String, full_text: String, created_at: Timestamp, analyzed_at: Timestamp, sentiment: Int, fk_tweet: Long)
